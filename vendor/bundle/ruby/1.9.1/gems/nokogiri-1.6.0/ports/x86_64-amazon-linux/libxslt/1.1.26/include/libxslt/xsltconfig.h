...
#define WITH_MODULES
#endif
#define LIBXSLT_DEFAULT_PLUGINS_PATH() "/apps/pcj/vendor/bundle/ruby/1.9.1/gems/nokogiri-1.6.0/ports/x86_64-amazon-linux/libxslt/1.1.26/lib/libxslt-plugins"
#endif
